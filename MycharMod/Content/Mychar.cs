...
using MycharMod.Modules.Characters;
using UnityEngine;

namespace MycharMod.Modules.Survivors
{
    internal class Mychar : SurvivorBase
    {
        public override string bodyName => "Mychar";

        public const string HENRY_PREFIX = MycharPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_";
        ...
        {
            bodyName = "HenryBody",
            bodyNameToken = MycharPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_NAME",
            subtitleNameToken = MycharPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_SUBTITLE",
        ...
        public override void InitializeSkills()
        {
            ...
            string prefix = MycharPlugin.DEVELOPER_PREFIX;
        ...
        public override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(MycharPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_DEFAULT_SKIN_NAME",
